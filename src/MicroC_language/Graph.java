...
public class Graph<V> {
    ...
    public boolean addArc(V source, V end, String label) {
        ...
        if (!adjacencyList.containsKey(source)) {
            ...
            tempList.add(new Edge<V>(end, label));
            add(source, tempList);
            return true;
        }
        ...
        adjacencyList.get(source).add(new Edge<V>(end, label));
        return true;
    }
    ...
    public boolean addEdge(V vertexOne, V vertexTwo, String label) {
        ...
        if (!adjacencyList.containsKey(vertexOne)) {
            ArrayList<Edge<V>> tempList = new ArrayList<Edge<V>>();
            tempList.add(new Edge<V>(vertexTwo, label));
        ...
        if (!adjacencyList.containsKey(vertexTwo)) {
            ArrayList<Edge<V>> tempList = new ArrayList<Edge<V>>();
            tempList.add(new Edge<V>(vertexOne, label));
            add(vertexTwo, tempList);
            return true;
        }

        adjacencyList.get(vertexOne).add(new Edge<V>(vertexTwo, label));
        adjacencyList.get(vertexTwo).add(new Edge<V>(vertexOne, label));
        return true;
    }
